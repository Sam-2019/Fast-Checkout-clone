...
const Lock = () => {
  return (
    <svg
      ...
      style="enable-background:new 0 0 372.826 372.826;"
      xml:space="preserve"
    >
      <g>
        <path
          d="M303.761,153.483h-17.666V99.692C286.095,44.727,241.378,0,186.416,0c-54.982,0-99.691,44.721-99.691,99.692v53.791h-17.66
